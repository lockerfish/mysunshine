...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("rowId must not be -1", rowId != -1);
        ...
        assertTrue("Error: This means that the inserted record was not found.", 
            cursor.moveToFirst());
    ...
    public void testWeatherTable() {
        ...
        assertTrue("locationId must not be -1", locationId != -1);
